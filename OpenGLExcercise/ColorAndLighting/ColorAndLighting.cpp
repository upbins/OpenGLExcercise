...
int main()
{
	...
	Shader* ourShader = new Shader("../shaders/shader_sources.vs", "../shaders/shader_sources.fs"); // you can name your shader files however you like
	Shader* lampShader = new Shader("../shaders/shader_original_light.vs", "../shaders/shader_original_light.fs");
	Material* myMaterial = new Material(ourShader, glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f), 32.0f);
	float vertices[] = {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, texture2);
		glm::vec3 lightPos(10.0f, 10.0f, -5.0f);
		// render
		for (unsigned int i = 0; i < 10; i++) {
			...
			ourShader->setVec3("light.objectColor", 1.0f, 0.5f, 0.3f);
			ourShader->setVec3("light.ambientColor", 0.2f, 0.1f, 0.0f);
			ourShader->setVec3("light.diffuseColor", 1.0f, 1.0f, 1.0f);
		...
		lampmodelMat = glm::translate(lampmodelMat, glm::vec3(lightPos));
